...
**robmorgan** commented *Feb 16, 2023*

<!-- Prepend '[WIP]' to the title if this PR is still a work-in-progress. Remove it when it is ready for review! -->

## Description

Fixes #[PATCHER-78](https://gruntwork.atlassian.net/browse/PATCHER-78).
...
[PATCHER-78]: https://gruntwork.atlassian.net/browse/PATCHER-78?atlOrigin=eyJpIjoiNWRkNTljNzYxNjVmNDY3MDlhMDU5Y2ZhYzA5YTRkZjUiLCJwIjoiZ2l0aHViLWNvbS1KU1cifQ
<br />
***


**gruntwork-ci** commented *Feb 16, 2023*

Upgrade test results for build [471](https://circleci.com/gh/gruntwork-io/terraform-aws-utilities/471)

- Modules upgraded from origin/HEAD => [`feature/per-module-release-notes-78`](https://github.com/gruntwork-io/terraform-aws-utilities/tree/feature/per-module-release-notes-78/)
