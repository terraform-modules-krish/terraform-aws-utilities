...
See the [executable-dependency example](https://github.com/terraform-modules-krish/terraform-aws-utilities/blob/v0.8.0/examples/executable-dependency) for working sample code.
