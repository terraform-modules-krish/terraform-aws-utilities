...
See the [instance-type example](https://github.com/terraform-modules-krish/terraform-aws-utilities/blob/v0.9.3/examples/instance-type) for working sample code.
