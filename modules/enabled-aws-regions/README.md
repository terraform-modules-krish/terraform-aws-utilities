...
See the [enabled-aws-regions example](https://github.com/terraform-modules-krish/terraform-aws-utilities/blob/v0.1.4/examples/enabled-aws-regions) for working sample code.
