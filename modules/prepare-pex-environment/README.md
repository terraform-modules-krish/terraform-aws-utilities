...
See the [`pex/sample-python-script` example](https://github.com/terraform-modules-krish/terraform-aws-utilities/blob/v0.8.0/examples/pex/sample-python-script) for an example implementation that you
