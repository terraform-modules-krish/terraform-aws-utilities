...
See the [require-executable example](https://github.com/terraform-modules-krish/terraform-aws-utilities/blob/v0.0.8/examples/require-executable) for working sample code.
